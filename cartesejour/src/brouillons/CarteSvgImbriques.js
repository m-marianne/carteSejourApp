...
class Carte extends Component {
	...
	// createGrad(){
	// 	let dataColor = Object.values(this.props.mapElements[this.props.indexMapElements].feeling);

	// 	const nodeD3_Grad = new ReactFauxDOM.createElement('svg');
	// 	let defsGrad = d3.select(nodeD3_Grad).attr('id', 'defsGrad')
	// 	//définition du dégradé svg (objet)
	// 	let grads = DefsGrad.append('defs')
